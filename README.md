      ...
      <div class="cols">
        ...
        <aside>
          ...
          <div class="info-list">
            ...
            <div class="info-item"><b>Білімі:</b> Қ. Жұбанов атындағы Ақтөбе Өңірлік МУ — Ақпараттық жүйелер;<br>Қорқыт Ата атындағы Қызылорда университеті — Математика-Информатика</div>
